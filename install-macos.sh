...
# Simple installer for Lime macOS binary.
...
# Examples:
#   bash install-macos.sh Banyango/lime
#   bash install-macos.sh Banyango/lime lime-macos-0.3.3
#   bash install-macos.sh Banyango/lime https://github.com/owner/repo/releases/download/v0.3.3/lime-macos-0.3.3

VERSION=0.0.1
REPO="Banyango/lime"
ASSET_ARG="lime-macos-$VERSION"
...
echo "Installed lime -> $TARGET_PATH"
...
echo "Done. Run 'lime --help' to verify."
