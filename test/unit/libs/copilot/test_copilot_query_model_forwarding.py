...
from libs.copilot.copilot_agent import CopilotQuery
...
async def test_execute_query_forwards_model_from_execution_model(monkeypatch):
    ...
    monkeypatch.setattr("libs.copilot.copilot_agent.create_get_variable_tool", fake_get_variable_tool)
    monkeypatch.setattr("libs.copilot.copilot_agent.create_set_variable_tool", fake_set_variable_tool)
    ...
    monkeypatch.setattr("libs.copilot.copilot_agent.SessionConfig", DummySessionConfig)
