...
# Simple installer for Lime Linux binary.
...
# Examples:
#   bash install-linux.sh Banyango/lime
#   bash install-linux.sh Banyango/lime lime-linux-0.3.3
#   bash install-linux.sh Banyango/lime https://github.com/owner/repo/releases/download/v0.3.3/lime-linux-0.3.3

VERSION=0.0.1
REPO="Banyango/lime"
ASSET_ARG="lime-linux-$VERSION"
