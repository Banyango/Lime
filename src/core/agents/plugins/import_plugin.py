                    ...
                    try:
                        ...
                        if added:
                            try:
                                ...
                                execution_model.add_log(f"Error importing {alias.name} after adding venv site-packages: {e}")
                ...
                try:
                    ...
                    if added:
                        try:
                            ...
                            execution_model.add_log(f"Error importing {node.module} after adding venv site-packages: {e}")
                            execution_model.add_import_error(str(e))
                            continue
